...
> 
> - 🇪🇸 [Español](README.es.md) (Documentación principal)
...
- **400 Bad Request** - Información de tracking demasiado antigua
  ```json
  {
      ...
      "error": {
          ...
          "details": "La información de tracking encontrada es demasiado antigua (más de 80 días). Por favor verifique que la información enviada sea correcta y considere proporcionar la naviera."
      }
  }
  ```
...
**Descripción:** Obtiene la información completa de un embarque por su ID, incluyendo datos de tracking, fechas de milestones (ETA, ETD, ATA, ATD), información de la naviera y detalles de contenedores.
